...
REM
REM Generated by Vivado on Thu Apr 30 01:31:13 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_kmeans_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_kmeans_top_vlog.prj -log xvlog.log
