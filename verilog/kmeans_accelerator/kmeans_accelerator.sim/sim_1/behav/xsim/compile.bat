...
REM
REM Generated by Vivado on Mon Apr 27 16:38:04 +0530 2026
...
echo "xvlog --incr --relax -prj tb_centroid_regs_vlog.prj"
call xvlog  --incr --relax -prj tb_centroid_regs_vlog.prj -log xvlog.log
