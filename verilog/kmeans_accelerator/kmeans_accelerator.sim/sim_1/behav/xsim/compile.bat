...
REM
REM Generated by Vivado on Mon Apr 27 16:27:15 +0530 2026
...
echo "xvlog --incr --relax -prj tb_min_finder_k4_vlog.prj"
call xvlog  --incr --relax -prj tb_min_finder_k4_vlog.prj -log xvlog.log
